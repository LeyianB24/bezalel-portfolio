...
import { 
  ...
  Code2, Battery, Globe2, Fingerprint, Bell, 
  Activity, Command, Settings, Layers, 
  Share2, ShieldCheck, Terminal, ScanLine, Database, 
  Lock
} from "lucide-react";

type Platform = 'ios' | 'android';

export default function MobileArchitecture() {
  ...
  return (
    <main className="min-h-screen bg-[#020617] text-slate-100 pt-24 pb-20 overflow-x-hidden selection:bg-white/20 font-sans perspective-[2000px]">
...
function InteractivePhone({ theme, platform }: any) {
     ...
     >
        ...
        >  
           ...
           <motion.div 
             ...
             className={`absolute left-[-50px] right-[-50px] h-[2px] ${theme.bg} z-50 blur-[2px] shadow-[0_0_20px_2px_currentColor] opacity-50 pointer-events-none`}
...
function PhoneLayer({ z, className, children }: any) {
   return (
      <div 
