...
// app/services/web-systems/page.tsx
"use client";
...
export default function WebSystems() {
  ...
  return (
    <main ref={containerRef} className="min-h-screen bg-[#030712] text-slate-200 pt-32 pb-20 overflow-x-hidden selection:bg-purple-500/30 font-sans">
